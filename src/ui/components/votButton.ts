...
export default class VOTButton {
  ...
  constructor({
    ...
    this.learnButton = elements.learnButton;
  ...
  private createElements() {
    ...
    const learnButton = UI.createEl("vot-block", ["vot-segment-only-icon"]);
    learnButton.setAttribute("role", "button");
    learnButton.tabIndex = 0;
    learnButton.setAttribute("aria-label", "Language Learning Mode");
    render(LEARN_ICON, learnButton);
